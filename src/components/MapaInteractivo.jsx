      ...
      <div className="row">
              ...
              {nichoEncontrado && (
                <>
                  <line
                    ...
                    y1="200"
                    x2="150"
                    y2={nichoEncontrado.y + 10}
                    stroke="#ff0000"
                    strokeWidth="2"
                  />
                  <line
                    x1="150"
                    y1={nichoEncontrado.y + 10}
                    x2={nichoEncontrado.x + 10}
                    y2={nichoEncontrado.y + 10}
                    stroke="#ff0000"
                    strokeWidth="2"
                  />
                  <circle
                    cx={nichoEncontrado.x + 10}
                    cy={nichoEncontrado.y + 10}
                    r="5"
                    fill="#ff0000"
                  />
                </>
        ...
        <div className="col-lg-4 col-md-12 d-flex flex-column justify-content-center">
          <form>
            ...
            <div className="mb-3">
              <label htmlFor="fechaFallecimiento" className="form-label">
